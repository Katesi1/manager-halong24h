        ...
        <div className="absolute inset-x-0 bottom-12 px-12">
          <span className="inline-flex items-center gap-2">
            ...
            <span className="font-display text-2xl font-bold text-white">
              ...
              <span className="ml-1 text-lg font-normal text-white/70">Manager</span>
            </span>
          </span>
          <p className="mt-6 max-w-md font-display text-3xl font-bold leading-snug text-white">
            Quản lý cơ sở lưu trú tại Hạ Long — Dễ dàng & Hiệu quả.
          </p>
          <p className="mt-3 max-w-md text-sm text-white/80">
            Quản lý đặt phòng, doanh thu, nhân viên · Dành cho chủ nhà và quản trị viên.
          </p>
        </div>
      </div>
        ...
        <header className="flex items-center p-6 lg:hidden">
          <span className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold tracking-tight text-navy-900">
              ...
              <span className="ml-1 text-sm font-normal text-ink-400">Manager</span>
            </span>
          </span>
        </header>
