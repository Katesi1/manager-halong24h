...
import { getKycAdminDetailAction } from '@/app/actions/kyc-admin';
import {
  KycPaymentsSection,
  KycUploadsSection,
...
export async function generateMetadata(props: {
  ...
  const result = await getKycAdminDetailAction(id);
  if (result.ok && result.data) {
    return { title: `KYC · ${displayName(result.data.user.name, result.data.user.email)}` };
  }
